    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                Row(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                        Text(text = "시간표", color = YwTextPrimary, fontSize = 20.sp, fontWeight = FontWeight.SemiBold)
                        Text(text = "이번 학기 수업 일정을 확인해요", color = YwTextSecondary, fontSize = 13.sp)
                    }
                    Box(
                        modifier = Modifier
                            .size(38.dp)
                        ...
                        Icon(
                            ...
                            contentDescription = "LMS에서 시간표 가져오기",
                ...
                if (entries.isEmpty()) {
                    Column(
                        ...
                        Text(text = "등록된 수업이 없어요", color = YwTextSecondary, fontSize = 13.sp)
                        Text(text = "오른쪽 아래 편집 버튼으로 추가해보세요", color = YwTextSecondary, fontSize = 12.sp)
                    }
                } else {
                    Column(
                        modifier = Modifier
            ...
            AppTabBar(
                ...
                onTabSelected = { tab ->
                    selectedTab = tab
                    if (tab == AppTab.Home) onNavigateHome()
                },
